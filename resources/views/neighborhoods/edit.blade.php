    ...
    <div class="row">
        <div class="col-lg-12 margin-tb mt-4">
            <div class="float-left">
                <h2 class="text-3xl">Editar Bairro</h2>
            </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="name" name="neighborhood_name" class="form-control" placeholder="Bairro" value="{{ $neighborhood->neighborhood_name }}"/>
            </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <select name="city_id" class="form-control" placeholder="Cidade">
                        @foreach ($cities as $city)
                            <option {{ $neighborhood->city->id === $city->id ? 'selected' : '' }} value="{{ $city->id }}">{{ $city->city_name }}</option>
                        @endforeach
                    </select>
            </div>
            </div>
